...
void draw(){
  background(255);
  image(ukraineImg, 600,300,500,500);
  s1.display();
  s1.update();
  if (s1.center_x >= 500 && s1.center_x <= 1100)
    image(explosion, 600,300,1000,1000);
